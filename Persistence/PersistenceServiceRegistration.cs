...
public static class PersistenceServiceRegistration
{
    public static IServiceCollection AddPersistenceServices(this IServiceCollection services, IConfiguration configuration)
    {
        ...
        services.AddScoped<IAboutSubRepository, AboutSubRepository>();
        services.AddScoped<IMinistrationRepository, MinistrationRepository>();

        services.AddScoped<IUsageAreaRepository, UsageAreaRepository>();
        ...
        services.AddScoped<IServiceSummaryRepository, ServiceSummaryRepository>();
