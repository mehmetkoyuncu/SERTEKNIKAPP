...
using Application.Services.SampleEntities;
using Application.Services.Abouts;
using Application.Services.AboutSubs;
using Application.Services.Ministrations;
using Application.Services.UsageAreas;
using Application.Services.Portfolios;
using Application.Services.PortfolioCategories;
using Application.Services.Contacts;
using Application.Services.Offers;
using Application.Services.CompanyInfoes;
using Application.Services.ServiceSummaries;
...
public static class ApplicationServiceRegistration
{
    ...
    )
    {
        ...
        services.AddScoped<ISampleEntityService, SampleEntityManager>();
        services.AddScoped<IAboutService, AboutManager>();
        services.AddScoped<IAboutSubService, AboutSubManager>();
        services.AddScoped<IMinistrationService, MinistrationManager>();
        services.AddScoped<IUsageAreaService, UsageAreaManager>();
        ...
        services.AddScoped<IServiceSummaryService, ServiceSummaryManager>();
